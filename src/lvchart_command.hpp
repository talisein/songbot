...
class lvchart_command : public iface_command
{
public:
    lvchart_command(context &ctx) noexcept;
    ...
    prometheus::Counter* lvchart_success_counter;
    prometheus::Counter* lvchart_failure_counter;
};
