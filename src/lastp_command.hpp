...
class lastp_command : public iface_command
{
public:
    lastp_command(context &ctx) noexcept;
...
private:
    ...
    prometheus::Counter* lastp_success_counter;
    prometheus::Counter* lastp_failure_counter;

    prometheus::Counter* ac_lastp_success_counter;
    prometheus::Counter* ac_lastp_no_match_counter;
    prometheus::Counter* ac_lastp_failure_counter;
