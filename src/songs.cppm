...
constexpr std::vector<Song> generate_songs_incomplete()
{
  ...
  {"右肩の蝶", "Migikata no Chou", "Butterfly on Your Right Shoulder", Len, "Nori-P"},
  ...
  {"結ンデ開イテ羅刹ト骸", "Musunde Hiraite Rasetsu to Mukuro", "Close and Open, Demons and The Dead", Miku, "Hachi"},
  {"カラフル×メロディ", "Colorful × Melody", "Colorful × Melody", duet(Miku, Rin), "Team MOER"},
  ...
  {"ダブルラリアット", "Double Lariat", "Double Lariat", Luka, "Agoaniki-P", nullopt, nullopt, nullopt, "<a:doublelariat:394562140096167937>"},
  {nullopt, nullopt, "Drag the ground", Miku, "Camellia", nullopt, nullopt, nullopt, "<:racingmikuhappy:805737573653544972>"},
  ...
  {nullopt, nullopt, "Fire◎Flower", Len, "halyosy"},
  ...
  {"ココロ", "Kokoro", "Heart", Rin, "Toraboruta-P"},
  ...
  {"みくみくにしてあげる♪", "Miku Miku ni Shite Ageru♪", "I'll Miku-Miku You♪ (For Reals)", Miku, "MOSAIC.WAV×ika"},
  ...
  {"アイ", "Ai", "Love", Miku, "DECO*27", nullopt, nullopt, nullopt, "<a:mikusnowrng:926685701494435870>"},
  ...
  {"好き！雪！本気マジック", "Suki! Yuki! Maji Magic", "Love! Snow! Really Magic", Miku, "Mitchie M", nullopt, nullopt, nullopt, "<a:mikusnowrng:926685701494435870>"},
  {"忘却心中", "Boukyaku Shinjuu", "Lover's Suicide Oblivion", MEIKO, "OPA"},
  {"ラッキー☆オーブ", "Lucky☆Orb", "Lucky☆Orb", Miku, "emon(Tes.)", nullopt, nullopt, nullopt, "<:mikuwink:607623904797786152>"},
  ...
  {nullopt, nullopt, "METEOR", Miku, "DIVELA", nullopt, "Mirai Meteor"},
  {"マージナル", "Marginal", "Marginal", Miku, "OSTER project"},
  {"メランコリック", "Melancholic", "Melancholic", Rin, "Junky"},
  {"メルト", "Melt", "Melt", Miku, "ryo"},
  {"炉心融解", "Roshin Yuukai", "Meltdown", Rin, "iroha(sasaki)"},
  {"メズマライザー", "Mesmerizer", "Mesmerizer", duet(Miku, Teto), "32ki"},
  {"メテオ", "Meteor", "Meteor", Miku, "John Zeroness", nullopt, "OG Meteor"},
  {nullopt, nullopt, "Midnight Surf", duet(MEIKO, KAITO), "asicamo"},
  {nullopt, nullopt, "Miku", Miku, "Anamanaguchi", nullopt, "Anamanaguchi"},
  {nullopt, nullopt, "MikuFiesta", Miku, "AlexTrip Sands", nullopt, nullopt, nullopt, "<:mikufiesta:1404333620377817088>"},
  ...
  {nullopt, nullopt, "Pane dhiria", KAITO, "Shinjou-P"},
  {nullopt, nullopt, "Parades", Miku, "whoo"},
  {"完全性コンプレックス", "Kanzensei Complex", "Perfectionist Complex", Luka, "Yamikuro"},
  {"ピアノ×フォルテ×スキャンダル", "Piano × Forte × Scandal", "Piano × Forte × Scandal", MEIKO, "OSTER project"},
  ...
  {"四角い地球を丸くする", "Shikakui Chikyuu wo Maruku Suru", "Round Off the Square Earth", Miku, "TOKOTOKO", nullopt, nullopt, nullopt, "<a:mikusnowrng:926685701494435870>"},
  ...
  {nullopt, nullopt, "Snow Fairy Story", Miku, "40mP", nullopt, nullopt, nullopt, "<a:mikusnowrng:926685701494435870>"},
  ...
  {"紡唄 -つむぎうた-", "Tsumugi Uta", "Spinning Song (Chinese ver.)", duet(Rin, Len), "DATEKEN", nullopt, "Chinese ver."},
  ...
  {nullopt, nullopt, "Tell Your World", Miku, "kz"},
  ...
  {"初音ミクの激唱", "Hatsune Miku no Gekishou", "The Intense Voice of Hatsune Miku", Miku, "cosMo"},
  {"白い雪のプリンセスは", "Shiroi Yuki no Princess wa", "The Snow White Princess is", Miku, "Noboru↑-P"},
  {"歌に形はないけれど", "Uta ni Katachi wa Nai Keredo", "Though My Song Has No Shape (Chinese ver.)", Miku, "doriko", nullopt, "Chinese ver."},
  {"歌に形はないけれど", "Uta ni Katachi wa Nai Keredo", "Though My Song Has No Shape", Miku, "doriko"},
  {"千本桜", "Senbonzakura", "Thousand Cherry Blossoms", Miku, "Kurousa-P"},
  ...
  {"二息歩行", "Nisoku Hokou", "Two Breaths Walking", Miku, "DECO*27", nullopt, nullopt, nullopt, "<a:TwoBreathHeart:841007262964121630>"},
  ...
  {"ビバハピ", "Viva Happy", "Viva Happy", Miku, "Mitchie M", nullopt, nullopt, nullopt, "<:mikuhappy:658349436375793670>"},
  ...
  {"ワールドイズマイン", "World is Mine", "World is Mine", Miku, "ryo", nullopt, nullopt, nullopt, "<:mikutriumph:510922356739276800>"},
  ...
  {nullopt, nullopt, "lost and found", Luka, "ashcolor", nullopt, nullopt, Miku},
