...
export struct Song
{
    ...
    constexpr Song(osv jp_name, osv romanji_name, sv name, Singer singer, sv producer, osv disam = std::nullopt, std::optional<Singer> minor_roles = std::nullopt, osv emoji_override = std::nullopt) noexcept :
        jp_name(jp_name),
...
constexpr std::vector<Song> generate_songs_incomplete()
{
  ...
  {"星のかけら", "Hoshi no Kakera", "Fragments of a Star", Miku, "Eiji Hirasawa"}, //https://vocadb.net/S/293725
  ...
  {"紡唄 -つむぎうた-", "Tsumugi Uta", "Spinning Song (Chinese ver.)", duet(Rin, Len), "DATEKEN", "Chinese ver."},
  ...
  {"歌に形はないけれど", "Uta ni Katachi wa Nai Keredo", "Though My Song Has No Shape (Chinese ver.)", Miku, "doriko", "Chinese ver."},
  ...
  {nullopt, nullopt, "01_ballade", Miku, "Eiji Hirasawa"}, // https://vocadb.net/S/2241
