...
class freq_command : public iface_command
{
public:
    freq_command(context &ctx) noexcept;
    ...
    prometheus::Counter* freq_success_counter;
    prometheus::Counter* freq_failure_counter;
};
