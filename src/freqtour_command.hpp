...
class freqtour_command : public iface_command
{
public:
    freqtour_command(context &ctx) noexcept;
    ...
    prometheus::Counter* freqtour_success_counter;
    prometheus::Counter* freqtour_failure_counter;
};
