...
#if __has_embed("event_pic_thumb_2939.png") == __STDC_EMBED_FOUND__
constexpr std::array event_pic_thumb_2939 = std::to_array<std::uint8_t>({
    #embed "event_pic_thumb_2939.png"
});
#else
...
/* Hatsune Miku GALAXY LIVE 2020 */
constexpr std::array<web_link, 1> web_links_2952 {{
  {"Other"sv, "Crypton Future Media (Press release)"sv, "https://www.crypton.co.jp/cfm/news/2020/09/03galaxylive2020"sv, 1506 },
}};

/* Hatsune Miku GALAXY LIVE 2020 */

#if __has_embed("event_pic_orig_2952.jpeg") == __STDC_EMBED_FOUND__
constexpr std::array event_pic_orig_2952 = std::to_array<std::uint8_t>({
    #embed "event_pic_orig_2952.jpeg"
});
#else
constexpr std::array<std::uint8_t, 0> event_pic_orig_2952;
#endif


#if __has_embed("event_pic_small_thumb_2952.jpeg") == __STDC_EMBED_FOUND__
constexpr std::array event_pic_small_thumb_2952 = std::to_array<std::uint8_t>({
    #embed "event_pic_small_thumb_2952.jpeg"
});
#else
constexpr std::array<std::uint8_t, 0> event_pic_small_thumb_2952;
#endif

constexpr std::array<std::uint8_t, 0> event_pic_thumb_2952;


#if __has_embed("event_pic_tiny_thumb_2952.jpeg") == __STDC_EMBED_FOUND__
constexpr std::array event_pic_tiny_thumb_2952 = std::to_array<std::uint8_t>({
    #embed "event_pic_tiny_thumb_2952.jpeg"
});
#else
constexpr std::array<std::uint8_t, 0> event_pic_tiny_thumb_2952;
#endif

constexpr release_event_picture event_picture_2952 = { "image/jpeg", std::nullopt, R"XYX(https://vocadb.t3.storage.dev/img/ReleaseEvent/mainOrig/2952.jpg?v=9)XYX"sv, event_pic_orig_2952, R"XYX(https://vocadb.t3.storage.dev/img/ReleaseEvent/mainSmall/2952.jpg?v=9)XYX"sv, event_pic_small_thumb_2952, R"XYX(https://vocadb.t3.storage.dev/img/ReleaseEvent/mainThumb/2952.jpg?v=9)XYX"sv, event_pic_thumb_2952, R"XYX(https://vocadb.t3.storage.dev/img/ReleaseEvent/mainTiny/2952.jpg?v=9)XYX"sv, event_pic_tiny_thumb_2952  };
...
/* Hatsune Miku GALAXY LIVE 2021 */
constexpr std::array<web_link, 2> web_links_3979 {{
  {"Other"sv, "Crypton Future Media (Press Release)"sv, "https://www.crypton.co.jp/cfm/news/2021/08/31galaxy21"sv, 2402 },
  {"Other"sv, "HATSUNE MIKU OFFICIAL BLOG"sv, "https://blog.piapro.net/2021/08/a2108311.html"sv, 2403 },
}};

/* Hatsune Miku GALAXY LIVE 2021 */

#if __has_embed("event_pic_orig_3979.png") == __STDC_EMBED_FOUND__
constexpr std::array event_pic_orig_3979 = std::to_array<std::uint8_t>({
    #embed "event_pic_orig_3979.png"
});
#else
constexpr std::array<std::uint8_t, 0> event_pic_orig_3979;
#endif


#if __has_embed("event_pic_small_thumb_3979.png") == __STDC_EMBED_FOUND__
constexpr std::array event_pic_small_thumb_3979 = std::to_array<std::uint8_t>({
    #embed "event_pic_small_thumb_3979.png"
});
#else
constexpr std::array<std::uint8_t, 0> event_pic_small_thumb_3979;
#endif

constexpr std::array<std::uint8_t, 0> event_pic_thumb_3979;


#if __has_embed("event_pic_tiny_thumb_3979.png") == __STDC_EMBED_FOUND__
constexpr std::array event_pic_tiny_thumb_3979 = std::to_array<std::uint8_t>({
    #embed "event_pic_tiny_thumb_3979.png"
});
#else
constexpr std::array<std::uint8_t, 0> event_pic_tiny_thumb_3979;
#endif

constexpr release_event_picture event_picture_3979 = { "image/png", std::nullopt, R"XYX(https://vocadb.t3.storage.dev/img/ReleaseEvent/mainOrig/3979.png?v=6)XYX"sv, event_pic_orig_3979, R"XYX(https://vocadb.t3.storage.dev/img/ReleaseEvent/mainSmall/3979.png?v=6)XYX"sv, event_pic_small_thumb_3979, R"XYX(https://vocadb.t3.storage.dev/img/ReleaseEvent/mainThumb/3979.png?v=6)XYX"sv, event_pic_thumb_3979, R"XYX(https://vocadb.t3.storage.dev/img/ReleaseEvent/mainTiny/3979.png?v=6)XYX"sv, event_pic_tiny_thumb_3979  };
...
#if __has_embed("event_pic_thumb_9341.jpeg") == __STDC_EMBED_FOUND__
constexpr std::array event_pic_thumb_9341 = std::to_array<std::uint8_t>({
    #embed "event_pic_thumb_9341.jpeg"
});
#else
...
Art by [のう](https://vocadb.net/Ar/10026), Design by [kannnu](https://twitter.com/sirakannnu))XYX"sv, 2020y/9/27, 2952, event_picture_2952, R"XYX(Hatsune Miku GALAXY LIVE 2020)XYX"sv, names_2952, 314, 2020, std::nullopt, 9083, R"(Hatsune Miku GALAXY LIVE 2020)", "Finished"sv, R"XYX(hatsune-miku-galaxy-live-2020)XYX"sv, R"XYX(INSPIX LIVE)XYX"sv, web_links_2952 },
...
Art by [左](https://vocadb.net/Ar/3104))XYX"sv, 2021y/10/24, 3305, event_picture_3305, R"XYX(Hatsune Miku "Magical Mirai 2021" in OSAKA)XYX"sv, names_3305, 81, 2021, std::nullopt, 9909, R"(Hatsune Miku Magical Mirai 2021)", "Approved"sv, R"XYX(hatsune-miku-magical-mirai-202)XYX"sv, std::nullopt, web_links_3305 },
  {R"XYX(初音ミク GALAXY LIVE 2021)XYX"sv, "Unspecified"sv, 2021y/12/18, R"XYX(Art by れおえん)XYX"sv, 2021y/12/19, 3979, event_picture_3979, R"XYX(Hatsune Miku GALAXY LIVE 2021)XYX"sv, names_3979, 314, 2021, std::nullopt, 9993, R"(Hatsune Miku GALAXY LIVE 2021)", "Finished"sv, R"XYX(hatsune-miku-galaxy-live-2021)XYX"sv, R"XYX(INSPIX LIVE)XYX"sv, web_links_3979 },
...
Art by [Tiv](https://vocadb.net/Ar/161497))XYX"sv, 2025y/8/3, 8768, event_picture_8768, R"XYX(Hatsune Miku "Magical Mirai 2025" in SENDAI)XYX"sv, names_8768, 81, 2025, std::nullopt, 20912, R"(Hatsune Miku "Magical Mirai" 2025)", "Finished"sv, R"XYX(hatsune-miku-magical-mirai-202)XYX"sv, std::nullopt, web_links_8768 },
  {R"XYX()XYX"sv, "Unspecified"sv, 2025y/11/5, std::nullopt, std::nullopt, 9341, event_picture_9341, R"XYX(Miku Expo 2025 Bangkok)XYX"sv, names_9341, 82, 2025, R"XYX(Bangkok)XYX"sv, 22929, R"(Miku Expo 2025 Asia)", "Finished"sv, R"XYX(miku-expo-2025-bangkok)XYX"sv, R"XYX(UOB LIVE)XYX"sv, web_links_9341 },
}};
